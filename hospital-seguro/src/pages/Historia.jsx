...
import '../styles/Historia.css';  // Import correcto del CSS
...
function Historia() {
  return (
    <div className="page-container">
      ...
      <p>
        Desde nuestra fundación, hemos trabajado para ofrecer servicios de salud, seguros y farmacia de calidad.
